...
//sempre que tiver um array ou objeto: informar manualmente o tipo da variável
interface Item {
    id: number,
    title: string,
    image_url: string
...
const CreatePoint = () => {
    ...
    function handleInputChange(e: ChangeEvent<HTMLInputElement>) {
        ...
        setFormData({ ...formData, [name]: value }) //o name é o nome que esta no target do input, atualiza somente o input que for alterado
    }
    ...
    function handleSelectItem(id: number) {
        ...
        if (alreadySelected >= 0) {
            //pega todos os items que tiverem o id diferente do que quer remover
